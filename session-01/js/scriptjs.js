...
// alert("Javascript code works well")
...
console.log([5, 10, 20, 15]); // Print an array
...
// let b = 25; // This will produce an error as identifier b is already declared
// console.log(b);
...
a = 20;
console.log(typeof a); // Print the type of the variable
console.log(a + 10); // Addition of number
